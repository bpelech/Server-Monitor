...
messaggio="Server $servername does not respond to ping since $seen." # Message in case the server is down
oggetto="Server: $servername is down!" # Subject in case the server is down
messaggio2="Server $servername now responds to ping. Was not responding since $seen." # Message in case the server is up
